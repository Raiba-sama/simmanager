                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="limite_credit_override" id="limite_credit_override" min="0" step="1"
                                   ...
                                   value="{{ old('limite_credit_override', $simRequest->limite_credit !== null ? $simRequest->limite_credit : '') }}" placeholder="Ex: 25000 (vide = Inchangé)">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="limite_data_override" id="limite_data_override" min="0" step="0.1"
                                   ...
                                   value="{{ old('limite_data_override', $simRequest->limite_data !== null ? $simRequest->limite_data : '') }}" placeholder="Ex: 4.5 (vide = Inchangé)">
